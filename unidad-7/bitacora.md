...
>  Profeeeee subí una versión anterior del proyecto (esa no es), como no se como borrar archivos (o si tengo permiso siquiera), le pido que por favor no tenga en cuenta entonces la carpeta "proyecto aerials" que es la version desactualziada unidad-7/proyecto
